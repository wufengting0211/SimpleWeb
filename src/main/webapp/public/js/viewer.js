 ...
 * @returns {boolean} Returns `true` if the given value is a string, else
 *          `false`.
 */
 ...
 * @param {*}
 *            value - The value to check.
 * @returns {boolean} Returns `true` if the given value is a number, else
 *          `false`.
 */
 ...
 * @param {*}
 *            value - The value to check.
 * @returns {boolean} Returns `true` if the given value is undefined, else
 *          `false`.
 */
 ...
 * context. Custom proxy to avoid jQuery's guid.
 * 
 * @param {Function}
 *            fn - The target function.
 * @param {Object}
 *            context - The new context for the function.
 ...
 * 
 * @param {Object}
 *            event - The target event object.
 * @param {boolean}
 *            endOnly - Indicates if only returns the end point coordinate or
 *            not.
 * @returns {Object} The result pointer contains start and/or end point
 *          coordinates.
 */
...
var methods = {
  ...
  /**
	 ...
	 * 
	 * @param {number}
	 *            offsetX - The relative offset distance on the x-axis.
	 * @param {number}
	 *            offsetY - The relative offset distance on the y-axis.
	 */
  ...
  /**
	 ...
	 * @param {boolean}
	 *            [hasTooltip] - Indicates if it has a tooltip or not.
	 * @param {Event}
	 *            [_event] - The related event if any.
	 */
  ...
  /**
	 ...
	 *            [_event] - The related event if any.
	 * @param {Event}
	 *            [_zoomable] - Indicates if the current zoom is available or
	 *            not.
	 */
  ...
  /**
	 ...
	 * 
	 * @param {number}
	 *            scaleX - The scale ratio on the x-axis.
	 */
  ...
  /**
	 ...
	 * 
	 * @param {number}
	 *            scaleY - The scale ratio on the y-axis.
	 */
  ...
  /**
	 ...
	 *            scaleX - The scale ratio on the x-axis.
	 * @param {number}
	 *            [scaleY=scaleX] - The scale ratio on the y-axis.
	 */
...
var Viewer = function () {
  /**
	 ...
	 * 
	 * @param {Element}
	 *            element - The target element for viewing.
	 * @param {Object}
